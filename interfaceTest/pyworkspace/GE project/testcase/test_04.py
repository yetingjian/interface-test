...
class ContactsAndroidTests(unittest.TestCase):
    ...
    def Test_Add_group(self):
        ...
        time.sleep(2)
        self.swipeUp(55, 0.54, 0.94, 0.47)  # 选择月
        time.sleep(2)
...
def Test_all():
    ...
    # Test_all.addTest(ContactsAndroidTests("Test_Add_group"))  # 新增出团中团信息
    # Test_all.addTest(ContactsAndroidTests("Test_route_edit"))  # 详情查看-添加照片
    # Test_all.addTest(ContactsAndroidTests("Test_Guider_information"))  # 短信群发
    # Test_all.addTest(ContactsAndroidTests("Test_Room_Assingment_group"))  # 按组自动分房（有问题）
    # Test_all.addTest(ContactsAndroidTests("Test_Room_Assingment_handwork"))  # 手工分房
    # Test_all.addTest(ContactsAndroidTests("Test_Add_bill_expenditure"))  # 添加支出
    # Test_all.addTest(ContactsAndroidTests("Test_user_single"))  # 单个签到
    # Test_all.addTest(ContactsAndroidTests("Test_Notes_timekeeper"))  # 发送闹钟通知
    # Test_all.addTest(ContactsAndroidTests("Test_Notes_number"))  # 已阅读通知人数检查
    # Test_all.addTest(ContactsAndroidTests("Test_Guider_group_chat"))  # 团聊发送
    # Test_all.addTest(ContactsAndroidTests("Test_Guider_single_chat"))  # 私聊发送
    # Test_all.addTest(ContactsAndroidTests("Test_Guider_map"))  # 位置定位
    # Test_all.addTest(ContactsAndroidTests("Travel_Notes_Publish"))  # 游记发布
    # Test_all.addTest(ContactsAndroidTests("Test_Travel_Notes"))  # 点赞
    # Test_all.addTest(ContactsAndroidTests("Test_Guider_review"))  # 游记评论
...
if __name__ == '__main__':
    ...
    # suite.addTest(ContactsAndroidTests("Test_Add_group"))       #新增出团中团信息
    # suite.addTest(ContactsAndroidTests("Test_route_edit"))      #详情查看-添加照片
    # suite.addTest(ContactsAndroidTests("Test_Guider_information"))     #短信群发
    # suite.addTest(ContactsAndroidTests("Test_Room_Assingment_group"))        #按组自动分房（有问题）
    # suite.addTest(ContactsAndroidTests("Test_Room_Assingment_handwork"))     #手工分房
    ...
    # suite.addTest(ContactsAndroidTests("Test_Notes_timekeeper"))  #发送闹钟通知
    # suite.addTest(ContactsAndroidTests("Test_Notes_number"))       #已阅读通知人数检查
    ...
    # suite.addTest(ContactsAndroidTests("Test_Guider_map"))      #位置定位
