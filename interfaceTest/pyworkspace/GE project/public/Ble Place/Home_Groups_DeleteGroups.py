...
class ContactsAndroidTests(ContactsAndroid):
    u"""分组删除"""
    def Home_Groups_DeleteGroups(self):
        Time(1)
            ...
            try:
                if (l[i].text == "Create new group"):
                    ...
                    if (i > 1):
                        ...
                        sleep(3)
                        self.assertEqual(self.driver.find_element('id', 'com.ge.cbyge:id/act_group_delete_tips').text, 'Are you sure you want to delete this Group?',
                                         '删除点击失败')
                        ...
                        if (name1 not in l):
                            ...
                            print u"删除失败"
                        self.assertEqual(self.driver.find_element('id', 'com.ge.cbyge:id/textview').text,'Home','取消删除失败')
                    else:
                        print u"没有分组信息"
                        break
            except:
